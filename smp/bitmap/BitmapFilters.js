...
(function(){
	...
	smp.namespace("smp.bitmap.BitmapFilters");
	
	//constructor (instance creation)
	smp.bitmap.BitmapFilters = (function()
	{
		...
		function _saturate(originalImageData, value){
			...
			var newImageData = _createBitmapData(originalImageData.width, originalImageData.height);
